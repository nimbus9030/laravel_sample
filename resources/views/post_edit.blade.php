                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea id="content" name="content" class="form-control" cols="50" rows="10" required> {{ $post->content }} </textarea>
                            </div>
                        </div>
                        <input id=" {{ $post->id }} " name="id" value=" {{ $post->id }} " style="display:none">
                        <div class="form-group">
